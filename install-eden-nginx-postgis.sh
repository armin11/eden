...
# =============================================================================
#download and install closure-comiler
cd $APPS_HOME/eden/static/scripts/tools
wget https://dl.google.com/closure-compiler/compiler-latest.zip
unzip compiler-latest.zip
ln -s closure-compiler-v20200315.jar compiler.jar
# =============================================================================
cd $APPS_HOME
...
echo "SELECT pg_terminate_backend(pg_stat_activity.pid) FROM pg_stat_activity WHERE pg_stat_activity.datname = 'sahana';" > /tmp/delete_current_connections.sql
su - postgres -c "psql -q -p 5432 -f /tmp/delete_current_connections.sql"
su - postgres -c "dropdb -p 5432 sahana"
