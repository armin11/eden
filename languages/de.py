...
'Accompanying Relative': 'Begleitender Verwandter',
...
'Active': 'Aktiv',
'Active Missions': 'Aktive Aufträge',
...
'Add Contact Person': 'Kontaktperson hinzufügen',
...
'Add Disease Data': 'Krankheitsdaten hinzufügen',
...
'Add Job': 'Anstehende Arbeit hinzufügen',
...
'Add Tracing Record': 'Verfolgungsdatensatz hinzufügen',
...
'Alcohol': 'Alkohol',
'Alerts': 'Warnungen',
#'Alerts': 'Dringende Bedarfe', # see job module - maybe alter english name
'Algeria': 'Algerien',
...
'Asymptomatic, Clinical Signs Negative': 'Asymptomatisch, klinische Krankheitsanzeichen negativ',
'At/Visited Location (not virtual)': '/ In Augenschein genommener Ort (nicht virtuell)',
'At Risk': 'Risikopatient',
...
'Auxiliary Respiration': 'Hilfs-Beatmung',
...
'Confirmed': 'Bestätigt',
'Confirmed Positive': 'Bestätigt positiv',
'Confirmed Negative': 'Bestätigt negativ',
...
'Contact Tracings': 'Kontaktverfolgungen',
...
'Copy': 'Kopieren',
'Corona specialized Hospital': 'Corona Schwerpunkt Krankenhaus',
'Corona Treatment': 'Corona Behandlung',
'Cost Type': 'Kostentyp',
...
'Create Alert': 'Dringenden Bedarf erstellen',
...
'Create Disease': 'Krankheit anlegen',
...
'Create Job Type': 'Arbeitstyp erstellen',
...
'Create Mission': 'Auftrag erstellen',
...
'Create Resource Type': 'Ressourcentyp anlegen',
...
'Create Staff or Volunteer': 'Mitarbeiter oder Freiwilligen anlegen',
...
'Current Illness Status': 'Aktueller Krankheitsstatus',
'Current Location': 'Aktueller Standort',
'Current Location Country': 'Aktueller Standort - Land',
'Current Location Treating Hospital': 'Aktueller Standort - behandelndes Krankenhaus',
'Current Location Phone Number': 'Aktueller Standort - Telefonnummer',
'Current Log Entries': 'Aktuelle Protokolleinträge',
'Current Memberships': 'Aktuelle Mitgliedschaften',
'Current Monitoring Level': 'Aktuelle Monitoringstufe',
...
'Damage': 'Beschädigung',
'Damage sustained': 'Nachhaltige Beschädigung',
...
'Date Alert Sent': 'Bedarf angemeldet am',
'Date Applicant selected': 'Bewerberauswahl getroffen am',
'Date Available': 'Verfügbar ab',
'Date Created': 'Erstellt am',
'Date CVs sent to DM': 'Lebensläufe bereitgestellt am',
'Date DM talked to President': 'Gespräch mit Leitung am',
'Date Due': 'Fällig am',
'Date Joined': 'Eintrittsdatum',
'Date Modified': 'Geändert am',
'Date Needed By': 'Benötigt ab',
'Date President approved': 'Mitarbeiter durch Leitung freigegeben am',
...
'Date and Time when the person has been exposed': 'Datum und Uhrzeit, als die Person Kontakt hatte',
...
'Date of Treatment': 'Datum der Behandlung',
...
'Deceased, Clinical Signs Positive': 'Verstorben, klinische Zeichen positiv',
...
'Delete Home': 'Wohnstätte löschen',
...
'Delete Relative': 'Verwandten löschen',
...
'Deployable Members': 'Verfügbare Mitglieder',
'Deployments': 'Abordnungen',
...
'Diagnosis': 'Diagnose',
'Diagnosis Status': 'Diagnosestatus',
...
'Disease Tracking': 'Krankheitstracking',
'Dispensary': 'Arzneiausgabe',
...
'Edit Home': 'Wohnstätte bearbeiten',
...
'Edit Relative': 'Verwandten bearbeiten',
...
'Emergency Treatment Centre': 'Notfallambulanz',
'Emergency': 'Notfall',
...
'Estimated Reopening Date': 'Voraus. Wiedereröffnungstermin',
...
'Expected Return Home': 'Erwartete Rückkehr nach Hause',
'Expected Start Date': 'Erwartetes Start Datum',
...
'Exposure': 'Exposition',
'Exposure Date/Time': 'Datum/Uhrzeit der Exposition',
'Exposure Risk': 'Expositionsrisiko',
'Exposure Type': 'Expositions Typ',
...
'Gas Supply Type': 'Kraftstoffversorgungstyp',
'Gas Supply Left (in hours)': 'Restlicher Kraftstoffvorrat (in Stunden)',
...
'Help': 'Hilfe',
'Helpers needed': 'Benötigte Helfer',
'Helpers needed (max)': 'Maximal benötigte Helfer',
...
'High risk exposure': 'Hohes Expositionsrisiko',
'High': 'Hoch',
...
'Home Location': 'Wohnadresse',
'Home Phone Number': 'Telefon zu Hause',
'Home Relative': 'Verwandter zu Hause',
'Home': 'Wohnstätte',
...
'Hours Planned': 'Angesetzte Stunden',
'Hours': 'Stunden',
...
'Intensive Care': 'Intensivmedizinische Behandlung',
...
'Jobs': 'Anstehende Arbeiten',
'Jobs Type': 'Arbeitstyp', #jobs - not job - see work module
'Jordan': 'Jordanien',
...
'Lost': 'Verloren',
'Low risk exposure': 'Geringes Expositionsrisiko',
...
'Manage Aid': 'Verwaltung der Hilfe',
'Manage Jobs': 'Verwaltung der anstehenden Arbeiten',
...
'Manage Resources' : 'Verwaltung der Ressourcen',
...
'Measures': 'Maßnahmen',
'Medical Conditions': 'Medizinischer Zustand',
...
'Monitoring required until': 'Monitoring notwendig bis',
'Month': 'Monat',
...
'No known exposure': 'Keine bekannte Exposition',
...
'Patients': 'Patienten',
'Patient Tracking': 'Patiententracking',
...
'Post-Recovery Follow-Up': 'Nachsorgebehandlung',
'Poultry restocking, Rank': 'Geflügel auffüllen, Rank',
'Poultry': 'Geflügel',
'Pounds': 'Pfund',
'Power Failure': 'Netzausfall',
'Power Outage': 'Ausfall der Stromversorgung',
'Power Supply Type': 'Art der Stromversorgung',
...
'Registered users can' : 'Registrierte Nutzer könen die',
'to access the system' : 'verwenden um auf das System zuzugreifen',
...
'Requesting Manager': 'Verantwortlich für Anforderung',
...
'Severe': 'Ernsthaft',
'Severity': 'Wertigkeit',
'Severely Ill, Clinical Signs Positive': 'Schwerstkrank, klinische Krankheitsanzeichen positiv',
'Sex': 'Geschlecht',
...
'Staffing Level': 'Mitarbeiterausstattung',
'Stairs': 'Treppen',
...
'Statistic': 'Statistik',
'Statistics Data': 'Statistische Daten',
...
'Symptom Debut': 'Erste Symptome',
'Symptomatic, Clinical Signs Positive': 'Symptomatisch, klinische Krankheitsanzeichen positiv',
...
'The Patient Tracking system keeps track of all the evacuated patients & their relatives.': 'Das Patiententracking überwacht alle evakuierten Patienten und ihre Verwandten.',
...
'Trace Period before Symptom Debut (days)': 'Inkubationszeit (Tage)',
'Tracing': 'Verfolgung',
'Tracing Status': 'Verfolgungsstatus',
'Tracing Details': 'Details zur Verfolgung',
...
'Unknown': 'unbekannt',
'Unknown, Not Checked': 'Unbekannt, nicht überprüft',
...
'Votes': 'Abstimmungen',
'WASH': 'WASH',
'Watch Period after Exposure (days)': 'Beobachtungszeit nach Ausbruch (Tage)',
...
'Who is doing What and Where': 'Wer macht Was und Wo',
'Situation Awareness': 'Lageübersicht', 
